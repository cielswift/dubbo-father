...
public class TwoCodeVser {
    ...
    @RequestMapping("/cre")
    public String cre() throws IOException, WriterException, JSONException {
        ...
        map.put("path",imgUserRequest + ph + replace + ".png");
        objectMapper.writeValueAsString(map);

        JSONObject jsonObject = new JSONObject();
        jsonObject.put("path", imgUserRequest + ph + replace + ".png");


        String s = StringEscapeUtils.unescapeJava(jsonObject.toString());
        return s;
    }
